...
| ~~TUI enhancements~~ | [`tui-enhancements`](../../openspec/specs/tui-enhancements/spec.md) | **Cancelled (2026-08-10)**: architecturally unsuitable for this project; no viable alternative to the WebUI. Spec withdrawn; `opendoc-tui` crate and `tui` feature are removal candidates. |
