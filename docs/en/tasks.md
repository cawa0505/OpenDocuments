...
## 🎨 Future Work Packages (Phases 2-4)

- [ ] **Tauri 2.0 3-Column Desktop Cabin**: File tree explorer, in-place Monaco editor, spreadsheet canvas.
- [ ] **Stdio MCP Integration**: Expose OpenDocuments as a standard Stdio MCP server.
- [ ] **UI Gatekeeper Approval Modal**: Require human authorization before executing tool calls.
- [ ] **GitHub Skill Marketplace & SSG Publisher**: Skill distribution network and GitHub Pages publisher.
