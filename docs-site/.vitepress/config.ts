...
export default defineConfig({
  title: 'OpenDocuments',
  description: 'Open source self-hosted RAG platform for AI document search across local files and web sources. Ask questions with source citations.',
  lang: 'en-US',
  base: '/OpenDocuments/',
  ignoreDeadLinks: [/localhost/],

  head: [
    ['meta', { name: 'keywords', content: 'self-hosted rag, ai document search, open source rag, retrieval augmented generation, knowledge base, llm document search, ollama rag, vector search, semantic search, document qa, enterprise search alternative, mcp server' }],
    ['meta', { property: 'og:title', content: 'OpenDocuments - Self-Hosted RAG Platform for AI Document Search' }],
    ['meta', { property: 'og:description', content: 'Open source RAG platform that connects local files and web sources, then answers questions with citations.' }],
    ...
    ['meta', { name: 'twitter:description', content: 'Self-hosted AI document search across local files and web sources.' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      featureList: [
        ...
        'Local folder ingestion and web page connectors',
        'Ollama, OpenAI, Anthropic, Google, and xAI model providers',
        'MCP server for AI coding assistants',
        'CLI, TUI, Web UI, and HTTP API',
      ],
    })],
  ],
